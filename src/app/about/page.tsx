...
export default function AboutPage() {
  ...
  const t = {
    zh: {
      ...
      role: "全栈开发者",
      intro:
        "白天调性能、拆架构，晚上跟 AI 对线。一个被代码耽误的自驾爱好者，走过 31 个省，debug 过更多的 bug。",
      contact: "联系方式",
      phone: "电话",
      wechat: "微信",
      email: "邮箱",
    ...
    en: {
      ...
      intro:
        "Tuning performance by day, arguing with AI by night. A road-trip lover disguised as a developer — 31 provinces down, mass bugs debugged.",
      contact: "Contact",
      phone: "Phone",
      wechat: "WeChat",
      email: "Email",
  ...
  const techLogos: LogoItem[] = [
    ...
    { src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vuejs/vuejs-original.svg", alt: "Vue" },
        ...
        <AnimatedContent distance={25} duration={0.5} delay={0.1}>
          ...
          >
            <div className="flex items-center gap-6 mb-6">
              <div className={`relative w-24 h-24 rounded-full overflow-hidden ${isDark ? 'ring-2 ring-cyan-500/30 ring-offset-2 ring-offset-black' : 'ring-2 ring-blue-500/20 ring-offset-2 ring-offset-[#f8f8f8]'}`}>
                <img
                  src="/brand/logo.png"
                  alt={t.name}
            ...
            <div>
              <h4 className={`text-sm font-medium ${textMain} mb-3`}>{t.skills}</h4>
              <LogoLoop
                logos={techLogos}
                speed={40}
                logoHeight={28}
        ...
        <AnimatedContent distance={25} duration={0.5} delay={0.15}>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Phone */}
              <div className={`flex items-center gap-3 p-3 rounded-lg ${isDark ? 'bg-cyan-500/5' : 'bg-blue-500/5'}`}>
                <div className={`p-2 rounded-lg ${isDark ? "bg-cyan-500/10" : "bg-blue-500/10"}`}>
              ...
              {/* WeChat */}
              <div className={`flex items-center gap-3 p-3 rounded-lg ${isDark ? 'bg-green-500/5' : 'bg-green-500/5'}`}>
        ...
        <AnimatedContent distance={25} duration={0.5} delay={0.2}>
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm ${isDark ? 'bg-cyan-500/10 border border-cyan-500/30 text-cyan-300' : 'bg-blue-500/10 border border-blue-500/30 text-blue-600'}`}>
                <span className="text-base">🎮</span>
        ...
        >
          ...
          <div
            style={{
              ...
              borderTop: isDark ? "5px solid rgba(0,0,0,0.9)" : "5px solid rgba(15,23,42,0.9)",
            }}
          />
        </div>
      )}
