            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <p className={`${textMain}`}>f63b0ce4f9aa951deea8abbb05d36bb7</p>
                  <img src="/f63b0ce4f9aa951deea8abbb05d36bb7.jpg" alt="WeChat" className="w-16 h-16 rounded-lg object-cover border border-gray-300" />
                </div>
              </div>
            </div>
