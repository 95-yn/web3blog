...
export default function Home() {
  ...
  const t = {
    zh: { title: "一一的空间", welcome: "欢迎来到一一的空间", subtitle: "记录学习与思考的足迹", intro: "全栈开发者，热衷于探索新技术。熟悉 React、Vue、Node、Web3 等技术，专注前端工程化与性能优化，AI Agent工具开发学习中~" },
    en: { title: "Yiyi's Space", welcome: "Welcome to Yiyi's Space", subtitle: "Notes on Learning and Thinking", intro: "Full-stack developer passionate about exploring new technologies. Experienced with React, Vue, Node, and Web3, focused on frontend engineering and performance optimization, learning AI Agent tool development~" }
  }[language];
